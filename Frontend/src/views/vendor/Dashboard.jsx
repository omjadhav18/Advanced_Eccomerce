...
function Dashboard() {
  ...
  useEffect(()=>{
    apiInstance.get(`vendor/stats/${UserData()?.vendor_id}/`).then((response)=>{
      setStats(response.data[0])
    })
    apiInstance.get(`vendor/products/${UserData()?.vendor_id}/`).then((response)=>{
                ...
                <div role="tabpanel" className="tab-pane active" id="home1">
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      ...
                      <tr key={index}>
                      <th scope="row">
                        <img src={product.image} style={{width:"100px", height:"70px",objectFit:"cover",borderRadius:"15px"}} />
                      </th>
                      <td>{product.title}</td>
                      <td>{product.price}</td>
                      ...
                      <td>
                        <Link href="" className="btn btn-primary mb-1">
                          <i className="fas fa-eye" />
                        </Link>
                        <Link href="" className="btn btn-success mb-1">
